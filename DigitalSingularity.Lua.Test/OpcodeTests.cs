...
public unsafe class OpcodeTests
{
    ...
    private void ExpectPatchedLoadKxString(string expected)
    {
        ...
        Assert.That(this.HasOpcode(proto, OpCode.LoadKX), Is.True, () => this.DumpOpcodes(proto));
        Assert.That(this.HasOpcode(proto, OpCode.ExtraArg), Is.True, () => this.DumpOpcodes(proto));
    ...
    private void ReplaceWithLoadKx(Proto* proto)
    {
        ...
        proto->code[0] = CREATE_ABx(OpCode.LoadKX, 0, 0);
        proto->code[1] = CREATE_Ax(OpCode.ExtraArg, MAXARG_Bx + 1);
        proto->code[2] = CREATE_ABCk(OpCode.Return1, 0, 2, 0, false);
    ...
    {
        this.ExpectRunsWithOpcode(OpCode.ExtraArg, this.RepeatedListConstructor(MAXARG_vC + 2));
