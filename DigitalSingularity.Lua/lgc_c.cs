...
// #define CWUFIN	10
    ...
    private static readonly byte maskcolours = (byte)(bitmask(BLACKBIT) | WHITEBITS);

// /* mask with all GC bits */
// #define maskgcbits      (maskcolours | AGEBITS)
//
//
...
// }
    ...
    */
    private static void linkobjgclist(GCObject* o, GCObject* p)
    {
...
//       UpVal *uv = gco2upv(o);
//       if (upisopen(uv))
//         set2grey(uv);  /* open upvalues are kept gray */
//       else
...
//         set2grey(curr);  /* open upvalues are always gray */
