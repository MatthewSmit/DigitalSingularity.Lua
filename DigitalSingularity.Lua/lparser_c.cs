...
public static unsafe partial class Lua
{
     ...
     */
    private static partial void statement(LexState* ls);

    private static partial void expr(LexState* ls, expdesc* v);
...
//     }
//     default:
//       Debug.Assert(e->k == VINDEXI);  /* this one doesn't need any check */
