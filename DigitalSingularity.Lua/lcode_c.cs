...
//   luaX_syntaxerror(ls, msg);
    ...
    */
     ...
     */
    private static partial void luaK_storevar(FuncState* fs, expdesc* var, expdesc* ex)
    {
        switch (var->k)
        {
            case expkind.VLOCAL:
    ...
    */
     ...
     */
    private static partial void luaK_prefix(FuncState* fs, UnOpr opr, expdesc* e, int line)
    {
        expdesc ef = new()
        {
            k = expkind.VKINT,
     ...
     */
    private static partial void luaK_posfix(FuncState* fs, BinOpr opr, expdesc* e1, expdesc* e2, int line)
    {
