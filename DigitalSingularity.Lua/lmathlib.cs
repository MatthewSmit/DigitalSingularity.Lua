...
public static unsafe partial class Lua
{
    ...
    [
        new("random", CFunction.FromFunction(&math_random)),
        new("randomseed", CFunction.FromFunction(&math_randomseed)),
    ];
    ...
    [
        new("abs", CFunction.FromFunction(&math_abs)),
        new("acos", CFunction.FromFunction(&math_acos)),
        new("asin", CFunction.FromFunction(&math_asin)),
        new("atan", CFunction.FromFunction(&math_atan)),
        new("ceil", CFunction.FromFunction(&math_ceil)),
        new("cos", CFunction.FromFunction(&math_cos)),
        new("deg", CFunction.FromFunction(&math_deg)),
        new("exp", CFunction.FromFunction(&math_exp)),
        new("tointeger", CFunction.FromFunction(&math_toint)),
        new("floor", CFunction.FromFunction(&math_floor)),
        new("fmod", CFunction.FromFunction(&math_fmod)),
        new("frexp", CFunction.FromFunction(&math_frexp)),
        new("ult", CFunction.FromFunction(&math_ult)),
        new("ldexp", CFunction.FromFunction(&math_ldexp)),
        new("log", CFunction.FromFunction(&math_log)),
        new("max", CFunction.FromFunction(&math_max)),
        new("min", CFunction.FromFunction(&math_min)),
        new("modf", CFunction.FromFunction(&math_modf)),
        new("rad", CFunction.FromFunction(&math_rad)),
        new("sin", CFunction.FromFunction(&math_sin)),
        new("sqrt", CFunction.FromFunction(&math_sqrt)),
        new("tan", CFunction.FromFunction(&math_tan)),
        new("type", CFunction.FromFunction(&math_type)),
#if LUA_COMPAT_MATHLIB
        new("atan2", CFunction.FromFunction(&math_atan)),
        new("cosh", CFunction.FromFunction(&math_cosh)),
        new("sinh", CFunction.FromFunction(&math_sinh)),
        new("tanh", CFunction.FromFunction(&math_tanh)),
        new("pow", CFunction.FromFunction(&math_pow)),
        new("log10", CFunction.FromFunction(&math_log10)),
#endif
        // placeholders
        new("random", default),
        new("randomseed", default),
        new("pi", default),
        new("huge", default),
        new("maxinteger", default),
        new("mininteger", default),
    ];
